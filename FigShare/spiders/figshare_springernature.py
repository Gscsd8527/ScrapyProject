...
class FigshareSpider(RedisSpider):
    name = 'figshare_springernature'
    # allowed_domains = ['www.figshar.com']
    # start_urls = ['http://www.figshar.com/']
    redis_key = 'figshare_springernature:url'
    ...
    def parse(self, response, **kwargs):
        ...
        if not url.startswith('http'):
            json_data['url'] = 'https://springernature.figshare.com' + url
        if not url.startswith('http'):
            json_data['baseUrl'] = 'https://springernature.figshare.com' + baseUrl
